...
public class ExceptionAndValidationHandler extends ResponseEntityExceptionHandler {
	    ...
	    ResponseEntity<Response> outOfStudentException(StudentNotFound ex){
	        Response response = new Response();
	        response.setResponse(ex.getMessage());
	        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(response);
	    }
		@ExceptionHandler(TeacherNotFound.class)
	    ResponseEntity<Response> outOfTeacherException(TeacherNotFound ex){
	        Response response = new Response();
	        response.setResponse(ex.getMessage());
	        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(response);
	    }
		@ExceptionHandler(BranchNotFound.class)
	    ResponseEntity<Response> outOfBranchException(BranchNotFound ex){
	        Response response = new Response();
	        response.setResponse(ex.getMessage());
	        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(response);
	    }
		@ExceptionHandler(SubjectNotFound.class)
	    ResponseEntity<Response> outOfSubjectException(SubjectNotFound ex){
	        Response response = new Response();
	        response.setResponse(ex.getMessage());
	        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(response);
	    }
